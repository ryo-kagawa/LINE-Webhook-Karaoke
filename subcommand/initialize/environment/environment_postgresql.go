...
type Environment struct {
	...
	DATABASE_INITIALIZE_DATABASE string
}
...
func GetEnvironment() Environment {
	return Environment{
		...
		DATABASE_INITIALIZE_DATABASE: os.Getenv("DATABASE_INITIALIZE_DATABASE"),
	}
}
...
func (e Environment) Validate() error {
	...
	if e.DATABASE_INITIALIZE_DATABASE == "" {
		return errors.New("環境変数DATABASE_INITIALIZE_DATABASEが未設定です")
	}
